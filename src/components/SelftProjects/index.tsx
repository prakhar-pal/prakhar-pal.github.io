...
const ProjectCard = (props: IProjectCardProps) => {
    return (
        <div className="transition-all duration-50 flex flex-col border-solid border-spacing-1 border-fuchsia-500 rounded-lg shadow-card overflow-hidden">
            <img
                src={props.imgSrc}
                alt={props.name}
                height={1080}
            ...
            />
            <div className="p-4 h-full bg-transparent opacity-50 bg-white text-black">
                {props.description}
            </div>
        </div>
    )
